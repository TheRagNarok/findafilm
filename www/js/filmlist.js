$(function(){
  var filmlist = [
    { Title: 'Harry Potter and the Philosophers Stone', data: '(2001)' },
    { Title: 'Harry Potter and the Chamber of Secrets', data: '(2002)' },
    { Title: 'Harry Potter and the Prisoner of Azkaban', data: '(2004)' },
    { Title: 'Harry Potter and the Goblet of Fire', data: '(2005)' },
    { Title: 'Harry Potter and the Order of the Phoenix', data: '(2007)' },
    { Title: 'Harry Potter and the Half-Blood Prince', data: '(2009)' },
    { Title: 'Harry Potter and the Deathly Hallows – Part 1', data: '(2010)' },
    { Title: 'Harry Potter and the Deathly Hallows – Part 2', data: '(2011)' },
    { Title: 'Aruban florin', data: 'AWG' },
...
$('#autocomplete').autocomplete({
    ...
    onSelect: function (suggestion) {
       var thehtml = '<strong>Film Title:</strong> ' + suggestion.value + ' <br> <strong>Year:</strong> ' + suggestion.data;
